    ...
    <section className="relative overflow-hidden bg-surface-white py-28">
      <div className="relative mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="mb-16 text-center">
          <p className="mb-4 text-xs font-medium tracking-elegant text-subtle">SIMPLE & TRANSPARENT</p>
          ...
          <div className="space-y-6">
            {content[tab].map((item) => (
              <div key={item.step} className="group flex gap-6">
                ...
                {/* Content */}
                <div className="flex-1 rounded-2xl border border-border-light bg-surface-white p-6 pb-8 transition-all duration-300 hover:border-border hover:shadow-soft">
        ...
        <div className="mt-16 text-center">
          <a
            ...
            className="btn-premium inline-flex items-center gap-3 rounded-full bg-primary px-8 py-4 text-sm font-medium text-white transition-all duration-300 hover:bg-primary-hover"
          >
