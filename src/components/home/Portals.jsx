      ...
      <div className="relative mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="mb-32 grid items-center gap-16 lg:grid-cols-2">
          <div className="order-2 lg:order-1 reveal-left">
            ...
            <p className="mb-10 text-base leading-relaxed text-muted">
              The Tenant Portal gives every registered tenant a clear view of
              their journey with DCDH Empire.
            </p>
              ...
              {[
                {
                  ...
                  desc: "See all property enquiries and their status in one place.",
                  icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2",
                },
                {
                  title: "Referral Dashboard",
                  desc: "Track friends and properties you have referred.",
                  icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z",
                },
                {
                  title: "Tenant Wallet",
                  desc: "View rewards and referral earnings.",
                ...
                <div
                  key={i}
                  className="group flex items-start gap-4 rounded-xl glass-card p-5 border-gradient-hover transition-all duration-300 glass-hover"
                >
                  ...
                  <div>
                    <h4 className="flex items-center gap-2 text-sm font-semibold text-heading">
                      {item.title}
                      {item.soon && (
                        <span className="animate-pulse rounded-full bg-accent-soft px-2.5 py-0.5 text-[10px] font-medium tracking-wide text-accent-muted">
                          Coming Soon
                        </span>
                      )}
                    </h4>
          ...
          <div className="order-1 lg:order-2 reveal-right">
            <div className="group relative overflow-hidden rounded-2xl shadow-premium">
              ...
              <div className="absolute bottom-4 left-4 glass-dark rounded-full px-4 py-2">
                <span className="text-xs font-medium text-accent-light tracking-elegant">
                  TENANT PORTAL
                </span>
              </div>
            </div>
        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div className="reveal-right">
            ...
            <div className="mt-4 mb-6 accent-line" />
            <p className="mb-10 text-base leading-relaxed text-muted">
              A dedicated portal for owners to manage properties, documents and
              enquiries with complete transparency.
            </p>
              ...
              {[
                {
                  ...
                  desc: "Step-by-step owner onboarding and document upload for verification.",
                  icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z",
                },
                {
                  title: "Property Management",
                  desc: "Add, edit and manage multiple properties with photos and locations.",
                  icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4",
                },
                {
                  title: "Listing Status",
                  desc: "See status: Active, Pending Approval, Rejected.",
                  icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01",
                },
                {
                  title: "Performance Insights",
                  desc: "Insights on property performance and enquiries.",
