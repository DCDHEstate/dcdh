          ...
          <div className="order-2 lg:order-1 reveal-left">
            ...
            <div className="mb-10 space-y-4">
              {[
                ...
                <div key={i} className="group flex items-start gap-4 rounded-xl border border-border-light bg-surface-card p-5 border-gradient-hover transition-all duration-300 hover:border-border hover:shadow-soft">
