      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="mb-32 grid items-center gap-16 lg:grid-cols-2">
          <div className="order-2 lg:order-1">
            <p className="mb-4 text-xs font-medium tracking-elegant text-subtle">TENANT PORTAL</p>
            ...
            <div className="mb-10 space-y-4">
              {[
                ...
                <div key={i} className="group flex items-start gap-4 rounded-xl border border-border-light bg-surface-card p-5 transition-all duration-300 hover:border-border hover:shadow-soft">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-surface-subtle transition-colors duration-300 group-hover:bg-surface-subtle">
                  ...
                  <div>
                    <h4 className="flex items-center gap-2 text-sm font-semibold text-heading">
                      {item.title}
                      {item.soon && (
                        <span className="rounded-full bg-accent-soft px-2.5 py-0.5 text-[10px] font-medium tracking-wide text-accent-muted">Coming Soon</span>
                      )}
                    </h4>
        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div>
            <p className="mb-4 text-xs font-medium tracking-elegant text-subtle">OWNER PORTAL</p>
            ...
            <Link
              href="/owner-portal"
              className="group btn-premium inline-flex items-center gap-3 rounded-full border border-border bg-surface-white px-8 py-3.5 text-sm font-medium text-body shadow-soft transition-all duration-300 hover:border-faint hover:shadow-elevated"
            >
              Access Owner Portal
              <svg className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 8l4 4m0 0l-4 4m4-4H3" />
