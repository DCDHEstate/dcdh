    ...
    <section className="bg-surface py-28">
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="mb-16 text-center">
          <p className="mb-4 text-xs font-medium tracking-elegant text-subtle">CURATED SELECTION</p>
        ...
        <div className="grid gap-7 md:grid-cols-2 lg:grid-cols-3">
          {properties.map(p => (
            <div key={p.id} className="card-hover group overflow-hidden rounded-2xl border border-border-soft bg-surface-card">
              {/* Image */}
              <div className="relative h-60 overflow-hidden">
                ...
                <div className="absolute left-4 top-4 flex gap-2">
                  ...
                  {p.featured && (
                    <span className="flex items-center gap-1 rounded-full bg-accent-muted/90 px-3 py-1 text-[11px] font-medium tracking-wide text-white backdrop-blur-sm">
                      Featured
                    </span>
                  )}
                </div>
                ...
                <div className="absolute bottom-4 left-4">
                  <span className="text-xl font-semibold text-white drop-shadow-md">{p.price}</span>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <a
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-4 py-3 text-sm font-medium text-white transition-all duration-300 hover:bg-primary-hover"
                >
        ...
        <div className="mt-16 text-center">
          <Link
            href="/search"
            className="group btn-premium inline-flex items-center gap-3 rounded-full border border-border bg-surface-white px-10 py-4 text-sm font-medium text-body shadow-soft transition-all duration-500 hover:border-faint hover:shadow-elevated"
          >
            View All Properties
