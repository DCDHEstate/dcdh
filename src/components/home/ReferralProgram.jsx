    ...
    <section className="relative overflow-hidden bg-surface-white py-28">
      <div className="relative mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="mb-16 text-center">
          <p className="mb-4 text-xs font-medium tracking-elegant text-subtle">REFERRAL PROGRAM</p>
        ...
        <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-2">
          {/* Refer a Friend */}
          <div className="group rounded-2xl border border-border-light bg-surface-white p-8 transition-all duration-500 hover:border-border hover:shadow-elevated">
            ...
            <ul className="mb-8 space-y-3">
              <li className="flex items-start gap-3">
                <svg className="mt-0.5 h-4 w-4 shrink-0 text-subtle" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              ...
              className="group/link inline-flex items-center gap-2 text-sm font-medium text-body transition-colors duration-300 hover:text-heading"
            >
              Refer a Friend
        ...
        <div className="mx-auto mt-16 max-w-4xl">
          <div className="relative overflow-hidden rounded-2xl bg-primary px-10 py-14 text-center md:px-16">
            ...
            <div className="relative">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link
                  href="/referral"
                  className="rounded-full bg-surface-white px-8 py-3.5 text-sm font-medium text-heading transition-all duration-300 hover:bg-surface-subtle"
                >
                ...
                <a
                  ...
                  className="flex items-center gap-2 rounded-full border border-border-dark-hover bg-surface-dark-card px-8 py-3.5 text-sm font-medium text-heading-on-dark backdrop-blur-sm transition-all duration-300 hover:bg-white/10"
                >
