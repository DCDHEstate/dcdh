...
const faqs = [
  {
    ...
    answer:
      "We aim to respond within 2 hours on WhatsApp and within 24 hours for email enquiries. For urgent matters, calling us directly is the fastest option.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Simply fill out the contact form or message us on WhatsApp with your property details. Our team will verify and list your property within 48 hours.",
  },
  {
    question: "What areas do you cover in Jaipur?",
    answer:
      "We cover 25+ localities across Jaipur including Malviya Nagar, Vaishali Nagar, Mansarovar, C-Scheme, Raja Park, Tonk Road, and many more.",
  },
];
...
export default function ContactPage() {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(
      `https://wa.me/919257533440?text=${encodeURIComponent(message)}`,
      "_blank",
    );
  };
      ...
      <main className="overflow-hidden" ref={containerRef}>
        ...
        <section className="relative min-h-[60vh] overflow-hidden bg-surface-dark">
          ...
          <div className="pointer-events-none absolute inset-0">
            ...
            <div
              className="absolute bottom-1/4 left-1/3 h-56 w-56 animate-pulse-slow rounded-full bg-accent-light/15 blur-[80px]"
          ...
          <div className="relative mx-auto flex min-h-[60vh] max-w-7xl flex-col justify-center px-6 py-32 lg:px-8">
            <div className="max-w-2xl">
              ...
              <p className="reveal mb-8 max-w-xl text-lg leading-relaxed text-body-on-dark">
                Whether you want to rent, buy, list or refer a property — we're
                just a message away. Reach out and our team will respond within
                hours.
              </p>
                  ...
                  >
                    {method.badge && (
                      <div className="absolute right-4 top-4">
                        <span
                          className={`rounded-full px-3 py-1 text-xs font-semibold ${colors.bgLight} ${colors.text}`}
                        >
                          {method.badge}
                        </span>
                      </div>
                    ...
                    <div
                      className={`mb-4 flex h-14 w-14 items-center justify-center rounded-xl ${colors.bg} text-white shadow-lg ${colors.shadow}`}
                    >
                      {method.icon}
                    </div>
              ...
              <div className="reveal-left">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <p className="text-center text-sm text-muted">
                    By submitting, you'll be redirected to WhatsApp to complete
                    your enquiry
                  </p>
                </form>
              </div>
                ...
                <div className="rounded-2xl border border-whatsapp/30 bg-whatsapp/10 p-6">
                  <div className="flex items-center gap-4">
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-whatsapp shadow-lg">
                      <svg
                        className="h-6 w-6 text-surface-dark"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    <div>
                      ...
                      <p className="text-body">
                        <span className="text-2xl font-semibold text-whatsapp-dark">
                          2 Hours
                        </span>{" "}
                        on WhatsApp
                      </p>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="reveal flex flex-col items-center justify-between gap-8 md:flex-row">
              <div className="text-center md:text-left">
                <h3 className="text-2xl font-semibold text-heading-on-dark">
                  Need Immediate Help?
                </h3>
                <p className="text-body-on-dark">
                  Our team is available 7 days a week, 9 AM to 9 PM
                </p>
              </div>
