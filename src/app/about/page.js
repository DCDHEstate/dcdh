...
const values = [
  {
    ...
    title: 'Trust First',
    description: 'Every property is verified. Every deal is transparent. We build relationships, not just transactions.',
  },
  {
    icon: 'M13 10V3L4 14h7v7l9-11h-7z',
    title: 'Speed & Simplicity',
    description: 'WhatsApp-first communication. No endless paperwork. Find your property in days, not months.',
  },
  {
    icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z',
    title: 'People Over Profit',
    description: 'Zero brokerage for tenants. Fair pricing for owners. We succeed when you succeed.',
  },
  {
    icon: 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z',
    title: 'Innovation',
    description: 'Cutting-edge tech meets local expertise. We\'re building the future of real estate in India.',
  },
];

const timeline = [
  { year: '2019', title: 'The Beginning', description: 'Started as a focused brokerage in Jaipur with a simple promise: genuine listings and honest advice.' },
  { year: '2021', title: 'Growing Trust', description: 'Helped 200+ families find their homes. Expanded to 15+ localities across Jaipur.' },
  { year: '2023', title: 'Going Digital', description: 'Launched our first digital platform. Introduced WhatsApp-based property search.' },
  { year: '2024', title: 'Platform Launch', description: 'Full-scale platform launch with Owner Portal, Tenant Portal, and Admin Dashboard.' },
];
      ...
      <main className="overflow-hidden">
        ...
        <section className="relative min-h-[70vh] overflow-hidden bg-gray-950">
          ...
          <div className="pointer-events-none absolute inset-0">
            ...
            <div className="absolute bottom-1/4 left-1/4 h-64 w-64 animate-pulse rounded-full bg-orange-500/10 blur-[100px]" style={{ animationDelay: '1s' }} />
          </div>
          ...
          <div className="relative mx-auto flex min-h-[70vh] max-w-7xl flex-col justify-center px-6 py-32 lg:px-8">
            <div className="max-w-3xl">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 backdrop-blur-sm">
                ...
                <span className="text-sm font-medium text-gray-300">About DCDH Estate</span>
              </div>
              ...
              <p className="mb-10 max-w-2xl text-lg leading-relaxed text-gray-400">
                We're building India's most trusted, WhatsApp-first real estate platform.
                Where transparency meets technology, and every property journey is simplified.
              </p>
            ...
            <div className="grid items-center gap-16 lg:grid-cols-2">
                ...
                <div className="relative overflow-hidden rounded-3xl shadow-2xl">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 rounded-2xl border border-white/20 bg-white/10 p-6 backdrop-blur-xl">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-2xl font-bold text-white">Years of Trust</p>
              ...
              <div>
                ...
                <h2 className="mb-6 text-3xl font-bold tracking-tight text-gray-900 lg:text-4xl">
                  ...
                  <span className="block bg-gradient-to-r from-red-500 to-orange-500 bg-clip-text text-transparent">Digital Innovation</span>
                </h2>

                <div className="space-y-6 text-gray-600">
                  <p className="text-lg leading-relaxed">
                    Founded in 2019, DCDH Estate started as a focused brokerage serving tenants and owners
                    in Jaipur with a simple promise: <strong className="text-gray-900">genuine listings and honest advice.</strong>
                  </p>
                  <p className="leading-relaxed">
                    Over the years, our team has helped hundreds of families and investors find the right homes
                    and properties, learning exactly where traditional real estate breaks down.
                  </p>
                  <p className="leading-relaxed">
                    The new DCDH Real Estate Platform is the next step — converting those learnings into a
                    scalable digital product for India, powered by modern technology and WhatsApp-first communication.
                  </p>
                </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mb-16 text-center">
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2">
                ...
                <span className="text-sm font-medium text-gray-400">Our Purpose</span>
              </div>
                ...
                <div className="relative h-full rounded-[22px] bg-gradient-to-br from-red-500 to-red-600 p-10">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-lg leading-relaxed text-white/90">
                      To democratize real estate in India by making property discovery, verification and
                      closure accessible, transparent and hassle-free for every Indian family.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="relative h-full rounded-[22px] border border-white/5 bg-gray-900/50 p-10">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-lg leading-relaxed text-gray-400">
                      To become India's most trusted, WhatsApp-first real estate platform for tenants,
                      owners and partners — where every property journey can be tracked, verified and completed online.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto max-w-2xl text-center">
              <div className="rounded-3xl border border-gray-200 bg-white p-10 shadow-xl">
                ...
                <h3 className="mb-4 text-2xl font-bold text-gray-900">{timeline[activeTimeline].title}</h3>
                <p className="text-lg text-gray-600">{timeline[activeTimeline].description}</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mb-16 text-center">
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2">
                ...
                <span className="text-sm font-medium text-gray-400">The People Behind DCDH</span>
              </div>
              <h2 className="mb-4 text-3xl font-bold tracking-tight text-white lg:text-4xl">
                Leadership Team
              </h2>
              <p className="mx-auto max-w-2xl text-gray-400">
                Meet the people driving DCDH Estate's mission to transform real estate in India.
              </p>
            </div>
                ...
                >
                  <div className="relative aspect-[4/5] overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6">
                      <p className="mb-1 text-sm font-medium text-red-400">{founder.role}</p>
                      <h3 className="mb-3 text-2xl font-bold text-white">{founder.name}</h3>
                      <p className="text-sm leading-relaxed text-gray-400">{founder.bio}</p>

                      {/* Social Links */}
                      <div className="mt-4 flex gap-3 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                        <a href={founder.linkedin} className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/10 text-white transition-colors hover:bg-white/20">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800">
              ...
              <div className="relative px-8 py-16 text-center md:px-16 md:py-24">
                <h2 className="mb-4 text-3xl font-bold text-white md:text-4xl lg:text-5xl">
                  Ready to Find Your
                  <span className="block bg-gradient-to-r from-red-400 to-orange-400 bg-clip-text text-transparent">Dream Property?</span>
                </h2>
                <p className="mx-auto mb-10 max-w-2xl text-lg text-gray-400">
                  Join thousands of happy families who found their perfect home with DCDH Estate.
