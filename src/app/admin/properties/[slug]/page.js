          ...
          <div className="rounded-2xl border border-border bg-surface-white p-6 shadow-soft">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className={`rounded-full px-2 py-0.5 text-xs font-medium ${property.is_featured ? "bg-amber-100 text-amber-700" : "bg-gray-100 text-gray-500"}`}>
          ...
          <div className="rounded-2xl border border-border bg-surface-white p-6 shadow-soft">
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                className={`flex w-full items-center justify-center gap-2 rounded-xl border px-4 py-2.5 text-sm font-medium transition disabled:opacity-50 ${
                  property.is_featured
                    ? "border-amber-300 bg-amber-50 text-amber-700 hover:bg-amber-100"
                    : "border-border bg-surface-white text-body hover:bg-surface-subtle"
                }`}
              >
                <svg className="h-4 w-4" fill={property.is_featured ? "currentColor" : "none"} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                </svg>
                {property.is_featured ? "Unfeature Property" : "Feature on Homepage"}
              </button>
