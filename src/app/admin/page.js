    ...
    <div className="mx-auto max-w-5xl">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <StatCard
              ...
              subtitle={stats?.overduePayments > 0 ? "Needs attention" : undefined}
              icon={
                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          ...
          <div>
            <p className="text-sm font-semibold text-heading">Properties</p>
            <p className="text-xs text-muted">Review listings</p>
          </div>
        </Link>
        <Link
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-muted">Manage leases</p>
          </div>
        </Link>
        <Link
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-muted">Resolve issues</p>
          </div>
        </Link>
      </div>
