...
const adminFeatures = [
  {
    ...
    desc: "Track and manage all incoming leads from enquiries, referrals, and walk-ins.",
    icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2",
  },
  {
    title: "Property Verification",
    desc: "Review and approve property listings before they go live on the platform.",
    icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
  },
  {
    title: "User Management",
    desc: "Manage tenant, owner, and partner accounts with role-based access control.",
    icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z",
  },
  {
    title: "Analytics Dashboard",
    desc: "Monitor platform performance, conversion rates, and business metrics.",
    icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z",
  },
];
        ...
        <div className="relative mx-auto flex min-h-[70vh] max-w-7xl flex-col justify-center px-6 py-32 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="reveal mb-6 text-4xl font-semibold leading-tight tracking-tight text-heading-on-dark md:text-5xl lg:text-6xl">
              How <span className="text-gradient-gold">DCDH Empire</span> Works
            </h1>

            <p className="reveal mb-10 text-lg leading-relaxed text-body-on-dark md:text-xl">
              Whether you&apos;re searching for a home, listing your property,
              or referring friends – we&apos;ve made every step simple and
              transparent.
            </p>
          </div>
        </div>
              ...
              <div className="space-y-8">
                {getSteps().map((item, i) => (
                  ...
                  >
                    ...
                    {/* Content Card */}
                    <div
                      className={`flex-1 ${i % 2 === 1 ? "lg:pr-14" : "lg:pl-14"}`}
                    >
                      <div className="card-hover glow-accent group flex gap-5 rounded-2xl glass-card p-6 transition-all duration-300 hover:border-accent/20 lg:gap-6 lg:p-8 glass-hover">
                        ...
                        <div className="flex items-start gap-4">
                          <div className="hidden h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-surface-subtle transition-colors duration-300 group-hover:bg-accent-soft lg:flex">
                            <svg
                              className="h-6 w-6 text-body transition-colors group-hover:text-accent-dark"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
                          ...
                          <div>
                            <h3 className="mb-2 text-lg font-semibold text-heading lg:text-xl">
                              {item.title}
                            </h3>
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="reveal mb-16 text-center">
            ...
            <p className="mx-auto max-w-2xl text-body">
              Our admin team works behind the scenes to verify listings, manage
              leads, and ensure every property journey is smooth.
            </p>
            ...
            <div className="relative rounded-[14px] bg-gradient-to-br from-accent to-accent-dark px-8 py-16 text-center md:px-16 md:py-20">
              ...
              <div className="relative">
                ...
                <p className="mx-auto mb-10 max-w-2xl text-lg text-surface-dark/80">
                  Whether you&apos;re a tenant, owner, or partner – your
                  property journey begins here.
                </p>
